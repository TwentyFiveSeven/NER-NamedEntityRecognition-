...
class Model:
    ...
    def _build_placeholder(self):
        ...
        self.character = tf.placeholder(tf.int32, [None, None, None],name = "character")
        self.dropout_rate = tf.placeholder(tf.float32, name = "dropout_rate")
        self.sequence = tf.placeholder(tf.int32, [None],name = "sequence")
        self.character_len = tf.placeholder(tf.int32, [None, None],name = "character_len")
    ...
    def _build_crf_layer(self, target):
        with tf.variable_scope("crf_layer" + self.number):
            ...
            cost = tf.reduce_mean(-self.log_likelihood, name="op_cost")
